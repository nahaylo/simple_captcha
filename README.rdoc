...
==Installation
  ...
  gem "nahaylo-simple_captcha", :require => "simple_captcha"

or

  gem 'nahaylo-simple_captcha', :require => 'simple_captcha', :git => 'git://github.com/nahaylo/simple_captcha.git'
...
====FormBuilder helper
  ...
  <%= form_for @user do |form| -%>
    ...
    <%= form.simple_captcha :label => "Enter numbers..", :field_options => { :size => nil } %>
    ...
  <% end -%>
